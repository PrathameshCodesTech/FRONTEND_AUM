  ...
  return (
    <div className="admin-properties-page">
      ...
      <div className="property-stats">
        ...
        <div className="stat-card-property">
          <span className="stat-icon-property stat-icon-warning">
            {renderIcon('clock')}
          </span>
          <div className="stat-content-property">
